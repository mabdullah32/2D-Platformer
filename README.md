...
Plays similarly to hit game "20 Minutes Till Dawn," top-down (may experiment with the top-down aspect) with enemies surrounding the player. However, enemies will be fewer but stronger and firing multiple projectiles for the player to dodge.
